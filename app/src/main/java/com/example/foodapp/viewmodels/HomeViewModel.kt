...
class HomeViewModel(private val mealDatabase: MealDatabase):ViewModel() {
    ...
    fun getPopularMeals()=RetrofitInstance.api.getPopularMeals("Seafood").enqueue(object :Callback<MealsByCategoryList>{
    ...
    fun observeSearchMealsLiveData():LiveData<List<Meal>>{return searchMealLiveData}
    fun observePopularMealsLiveData():LiveData<List<MealsByCategory>>{return popularMealsLiveData}
    fun getCategories()=RetrofitInstance.api.getCategory().enqueue(object :Callback<CategoryList>{
    ...
    fun observeFavoritesMealsLiveData():LiveData<List<Meal>>{return favoritesMealsLiveData}
}